...
switch ($_REQUEST['form']) {
  case 'analytics':
    ...
    $arrResults['work'] = $arrResults['times']['categories'][3]['value'];
    $arrResults['sleep'] = $arrResults['times']['categories'][2]['value'];
    ...
    foreach ($arrMoneys as $arrMoney) {
      ...
      if ( (int)$arrMoney['category'] == 5 ) $iMonthSummSalaryWork = (int)$arrMoney['price'] + (int)$iMonthSummSalaryWork;
    }
