...
<section class="row block_moneys">
  <div class="col col-12">
    <div id="content_manager_buttons" class="content_manager_buttons _hide_" data-content_manager_action="moneys_categories" data-content_manager_block="#moneys_categories" data-content_manager_item=".money_category" data-content_manager_button=".content_manager_switch">
    ...
    <script>
      $(function(){
        ...
        $(document).find('#footer_actions').content_actions( {'action':'moneys_categories'} )
      })
    </script>
  </div>
      ...
      <span class="row d-flex w-100 justify-content-between align-items-start">
        ...
        <span class="col-12 col-xl-6 d-flex justify-content-end">
          <span class="btn-group">
            ...
            <a data-action="moneys_categories" data-animate_class="animate__flipInY" data-id="{{id}}" data-elem=".money_category" data-form="form" href="javascript:;" class="btn btn-dark content_loader_show _edit">
              <i class="fas fa-pen-square"></i>
            </a>

            <a href="#" class="btn btn-dark content_download _del" data-id="{{id}}" data-action="moneys_categories" data-form="del" data-elem=".money_category">
