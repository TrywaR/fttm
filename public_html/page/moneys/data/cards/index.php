<main class="container pt-4 pb-4">
  ...
  <div class="row">
    ...
    <div class="col col-12 col-md-6">
      ...
      <div id="content_manager_buttons" class="content_manager_buttons _hide_ d-flex justify-content-end mb-4" data-content_manager_action="cards" data-content_manager_block="#cards" data-content_manager_item=".card_item" data-content_manager_button=".content_manager_switch">
        ...
        <ol
          id="cards"
          class="block_cards block_elems block_content_loader list-group list-group-numbered"
  ...
  <div class="block_template">
    <li class="list-group-item d-flex _elem card_item justify-content-between align-items-start progress_block animate__animated animate__bounceInRight" data-content_manager_item_id="{{id}}"  data-id="{{id}}">
      ...
      <div class="rounded-pill">
        ...
        <a href="#" class="btn content_download" data-id="{{id}}" data-action="cards" data-elem=".list-group-item" data-form="edit" data-animate_class="animate__flipInY">
          <i class="fas fa-pen-square"></i>
        </a>
        <a href="#" class="btn content_download" data-id="{{id}}" data-action="cards" data-form="del" data-elem=".list-group-item">
