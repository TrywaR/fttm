<?$oLang = new lang()?>
<section class="row block_jumbotron block_clients">
...
<section class="row block_clients">
  <div class="col-12">
  ...
  <div class="block_template">
    <div class="col-12 mt-2 mb-2 _elem client progress_block animate__animated" data-content_manager_item_id="{{id}}"  data-id="{{id}}">
      <div class="card">
        <div class="card-body">
          <div class="row">
