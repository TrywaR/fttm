...
<section class="row block_jumbotron block_tasks">
  <div class="col col-12">
    <div class="_block_title">
      ...
      <div class="_buttons btn-group">
        <button class="accordion-button collapsed btn btn-dark" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTasks" aria-expanded="false" aria-controls="flush-collapseTasks">
  ...
  <div id="flush-collapseTasks" class="col-12 accordion-collapse collapse">
    <!-- Фильтр -->
