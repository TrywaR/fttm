    ...
    <div class="_section _title row">
      <div class="_block col-12 animate__animated animate__fadeIn">
        <div class="_content">
          ...
          <p>
            Это симулятор, способный оцифровать тебя, помогающий более эффективного распоряжаться своим временем и финансами
          </p>
          <p>
     ...
     <div class="container">
       <div class="_block col col-12 pt-4 pb-4">
         <div class="_content">
           ...
           <p>
             Учёт финансовых потоков для отслеживание их по категориям, проектам, взаимодействуя с неограниченным количеством носителей:
