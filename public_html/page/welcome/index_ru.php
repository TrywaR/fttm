     ...
     <div class="_block">
         ...
         <div class="_content">
           ...
           <ul>
             ...
             <li>Отслеживание периода на конкретные задачи, с определением планируемого времени и реально затраченного, что позволит отследить, насколько точно ты планируешь затраты по времени на задачи, и улучшить этот навык.</li>
           </ul>
         </div>
       </div>
   </div>
       ...
       <div class="_icon">
         ...
         <div class="_content">
           <h2 class="_block_title">Время и деньги</h2>
            ...
            <p>Например: Сколько стоит твой час работы, как в общем так и по отдельным проектам. Это позволит урегулировать стоимость своих услуг, учитывая финансовые и временные затраты на работу. </p>
